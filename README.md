...
* 🌐 **English & Russian** — switch language in the popup, onboarding, or Settings.
* ⚙️ **Settings panel** — change language, switch channel, and manage analytics preferences from the clips page.
* 🛡️ **Optional anonymous analytics** — opt-in only (off by default). Full Transparency Report and Privacy Policy are built into the extension.
...
> [!NOTE]  
> This method is the easiest and safest. Updates may appear with a slight delay due to Chrome Web Store moderation.
...
On first install, a short onboarding wizard helps you choose language and optional analytics preferences.

### Method 1. Via the popup

1. Click the extension icon in the browser toolbar.
2. Enter a Kick channel slug (for example, `Meiweif`) or paste a full Kick channel URL.
3. Click **Open clips**.
